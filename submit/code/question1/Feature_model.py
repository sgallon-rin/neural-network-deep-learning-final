...
Feature_max_size = 54 # the max dimension of features
...
if __name__ == '__main__':
    ...
    for feature_size in range(Feature_max_size): # try different dimension
        ...
        potential_feature = [i for i in range(Feature_max_size) if i not in Feature] # optional features
    ...
    Model_file = open('data_parts/model.pkl','wb')
