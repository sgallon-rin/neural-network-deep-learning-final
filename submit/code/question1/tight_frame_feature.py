...
def feature_set(S):
    ...
    for k in range(len(S)):
        ...
        pickle.dump(single_S, open('data_parts/N_' + str(index[k//4]) + '_'+str(k%4+1) +'.p', 'wb'))
...
if __name__ == '__main__':
    ...
    pickle.dump(np.array(T), open('data_parts/tight_frame_T.p', 'wb'))
    pickle.dump(np.array(N), open('data_parts/tight_frame_N.p', 'wb'))
    pickle.dump(np.array(D), open('data_parts/tight_frame_D.p', 'wb'))